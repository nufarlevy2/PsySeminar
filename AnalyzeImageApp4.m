function varargout = AnalyzeImageApp4(varargin)
% ANALYZEIMAGEAPP4 MATLAB code for AnalyzeImageApp4.fig
%      ANALYZEIMAGEAPP4, by itself, creates a new ANALYZEIMAGEAPP4 or raises the existing
%      singleton*.
%
%      H = ANALYZEIMAGEAPP4 returns the handle to a new ANALYZEIMAGEAPP4 or the handle to
%      the existing singleton*.
%
%      ANALYZEIMAGEAPP4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ANALYZEIMAGEAPP4.M with the given input arguments.
%
%      ANALYZEIMAGEAPP4('Property','Value',...) creates a new ANALYZEIMAGEAPP4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before AnalyzeImageApp4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to AnalyzeImageApp4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help AnalyzeImageApp4

% Last Modified by GUIDE v2.5 02-Jul-2018 21:41:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @AnalyzeImageApp4_OpeningFcn, ...
                   'gui_OutputFcn',  @AnalyzeImageApp4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AnalyzeImageApp4 is made visible.
function AnalyzeImageApp4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to AnalyzeImageApp4 (see VARARGIN)

% Choose default command line output for AnalyzeImageApp4
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes AnalyzeImageApp4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = AnalyzeImageApp4_OutputFcn(hObject, eventdata, handles) 
